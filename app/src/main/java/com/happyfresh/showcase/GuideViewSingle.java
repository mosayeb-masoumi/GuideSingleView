...
public class GuideViewSingle extends FrameLayout {

    static final String TAG = "GuideViewSingle";
    ...
    private GuideMessageViewSingle mMessageView;
    private boolean str = false;

    private GuideViewSingle(Context context, final View view) {
        super(context);
        ...
        mMessageView = new GuideMessageViewSingle(getContext());
...
//        }
    ...
    public void setButtonText(String buttonText){
        ...
        //     mMessageView.okButton.setTextAlignment(START);
        //     mMessageView.NoButton.setTextAlignment(Gravity.CENTER);
    ...
    public static class Builder {
        ...
        public Builder setButtonGravityNo(int buttonGravity){
            this.buttonGravity = buttonGravity;
            return this;
        }
        ...
        public GuideViewSingle build() {
            GuideViewSingle guideView = new GuideViewSingle(context, targetView);
