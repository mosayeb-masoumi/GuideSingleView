...
public class GuideMessageViewSingle extends LinearLayout {
    ...
    GuideMessageViewSingle(Context context) {
        super(context);
...
//        okButton.setTypeface(FontUtil.getInstance(App.myContext).getRegularFont());  // set font
